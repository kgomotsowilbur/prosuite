        ...
        <>
            {
                arrAbout.map((abt, index) => (
                    <div key={index} className="rounded flex flex-col w-full md:h-full p-6 lg:p-8 gap-2 md:gap-4 mix-blend-multiply shadow-md bg-white">
                        <div className="flex flex-row justify-center w-full">
                            <Image
                                ...
                                width={96}
                                height={150}
                                className="w-auto md:w-20 lg:w-32 h-40 md:h-auto"
                            />
                        </div> 
